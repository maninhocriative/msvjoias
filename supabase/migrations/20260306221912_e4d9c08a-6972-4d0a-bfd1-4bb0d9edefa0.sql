...
SELECT cron.schedule(
  ...
  SELECT net.http_post(
    ...
    body := '{"campaign_id": "dia-mulheres-2026", "message": "🌸 *Feliz Dia da Mulher!* 🌸\n\nQue tal eternizar um momento especial? 💝\n\nNossos *pingentes em aço inox* com *fotogravação GRÁTIS* são o presente perfeito!\n\nA partir de *R$ 139,00* ✨\n\n📸 Envie a foto que deseja gravar e nós fazemos pra você!\n\nResponda essa mensagem para saber mais! 💬", "video_url": "https://ahbjwpkpxqqrpvpzmqwa.supabase.co/storage/v1/object/public/products/campanha-dia-mulheres.mp4", "dry_run": false, "batch_size": 10}'::jsonb
  ) AS request_id;
  $$
);
